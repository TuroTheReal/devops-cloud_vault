...
<p align="center">
  <img src="https://img.shields.io/badge/Status-[Status]-[Color].svg"/>
  <img src="https://img.shields.io/badge/Updated-YYYY--MM-blue.svg"/>
  <img src="https://img.shields.io/badge/Difficulty-[Level]-[Color].svg"/>
</p>
...
graph LR
    ...
    B -->|Beginner| C[Fundamentals]
    B -->|Intermediate| D[Core Topics]
    B -->|Advanced| E[Deep Dive]
    C --> F[Practice]
    D --> F
    E --> F
    F --> G[Master]
